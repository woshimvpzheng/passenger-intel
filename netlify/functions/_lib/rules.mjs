...
export const categories = ["政策监管", "经营借鉴", "线路运营", "客流市场", "票价补贴", "风险预警", "区域动态"];

const roadKeywords = [
  "道路客运", "班线客运", "班车客运", "客运班线", "定制客运", "农村客运", "城乡客运",
  "城际客运", "旅游包车", "包车客运", "客运站", "汽车客运", "公路客运", "道路旅客运输",
  "道路运输", "客运企业", "客运集团", "旅客运输", "客运服务", "交旅融合",
];
...
export function fallbackDimensions(item, source) {
  ...
  return {
    ...
    businessValue: category === "经营借鉴" ? 86 : Math.min(78, 42 + points),
...
export function finalScore(dimensions, source, category) {
  ...
  const categoryBoost = category === "风险预警" ? 5 : category === "经营借鉴" ? 4 : category === "政策监管" ? 3 : 0;
